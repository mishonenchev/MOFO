...
namespace MOFO.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        [HttpGet]
        public JsonResult TelephoneValidation(string telephone, bool orderValidation = false)
        {
            return Json(new { status = "OK", isValid = _userService.IsTelephoneValid(telephone) }, JsonRequestBehavior.AllowGet);
        }
